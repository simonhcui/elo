...
overall_dict ["Chris A"] = [5, "9-5"]
overall_dict ["Simon"] = [5, "9-6"]
overall_dict ["Juwan"] = [5, "10-5"]
overall_dict ["Angga"] = [5, "5-10"]
overall_dict ["Jacob"] = [2, "2-3"]
overall_dict ["Sonny"] = [5, "8-6"]
overall_dict ["Matt"] = [5, "8-6"]
overall_dict ["Zane"] = [2, "0-5"]
overall_dict ["Nick D"] = [5, "8-7"]
overall_dict ["Vanndy"] = [2, "5-1"]
overall_dict ["Todd"] = [4, "5-7"]
overall_dict ["Patrick R"] = [1, "2-1"]
overall_dict ["Clayton"] = [2, "2-4"]
overall_dict ["Ana"] = [1, "2-1"]
overall_dict ["Alice"] = [2, "3-3"]
overall_dict ["Nick C"] = [1, "1-2"]
overall_dict ["Tomoya"] = [2, "1-5"]
overall_dict ["Travis"] = [1, "0-3"]
