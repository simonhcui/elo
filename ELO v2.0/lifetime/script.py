...
overall_dict["Nick D"] = [16, "31-14"]
overall_dict["Juwan"] = [17, "25-18"]
overall_dict["Chris H"] = [1, "2-1"]
overall_dict["Zane"] = [7, "4-14"]
overall_dict["Sonny"] = [12, "15-18"]
overall_dict["Chris A"] = [16, "22-21"]
overall_dict["Matt Y"] = [16, "22-15"]
overall_dict["Simon"] = [20, "27-26"]
overall_dict["Angga"] = [6, "8-10"]
overall_dict["Charles"] = [1, "2-1"]
overall_dict["Adam"] = [6, "11-6"]
overall_dict["Travis"] = [3, "1-7"]
overall_dict["Chris K"] = [3, "3-4"]
overall_dict["Mike"] = [1, "1-2"]
overall_dict["Todd"] = [10, "9-18"]
overall_dict["Evan K"] = [3, "2-6"]
overall_dict["Evan S"] = [2, "2-2"]
overall_dict["Ian"] = [2, "3-2"]
overall_dict["Jorgie"] = [4, "2-8"]
overall_dict["Clayton"] = [3, "4-4"]
overall_dict["Julio"] = [2, "2-4"]
overall_dict["Alice"] = [4, "6-5"]
overall_dict["Andre"] = [2, "0-4"]
overall_dict["Karen"] = [1, "2-0"]
overall_dict["Jacob"] = [2, "2-4"]
overall_dict["Vanndy"] = [2, "5-1"]
overall_dict["Patrick R"] = [1, "2-1"]
overall_dict["Ana"] = [2, "4-2"]
overall_dict["Michael D"] = [1, "2-1"]
overall_dict["Nick C"] = [2, "3-3"]
overall_dict["Tomoya"] = [3, "1-7"]
overall_dict["Ryan"] = [1, "0-2"]
