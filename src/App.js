...
import SeasonSix from "./Pages/seasonsix";
import SeasonSeven from "./Pages/seasonseven";
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/seasonsix" element={<SeasonSix />} />
        <Route path="/seasonseven" element={<SeasonSeven />} />
